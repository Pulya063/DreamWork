...
from database.schemas import AdviceRequest, VerifyTaskRequest, Hometask
...
async def personal_advice(
    ...
    from example_ai_responses import example_advice
...
async def verify_task(body: VerifyTaskRequest) -> Hometask:
    ...
    from example_ai_responses import task_response
