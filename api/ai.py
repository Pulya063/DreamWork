...
from database.schemas import AdviceRequest, VerifyTaskRequest
from database.db import SessionDep
from database.models import Simulation, Skill
from api.auth import CurrentUser
from services.ml_analyzer import analyzer
...
def get_ai_response(prompt: str) -> dict:
    ...
    if "You are a career advisor and labor market analyst" in prompt:
        from example_ai_responses import simulation
        return simulation
...
async def personal_advice(
    ...
    prompt = (
        f"Ти досвідчений кар'єрний консультант. Користувач: {current_user.first_name} {current_user.last_name}, "
...
async def verify_task(
    ...
    prompt = (
        ...
        f"Звіт користувача: \"{body.user_report}\".\n\n"
